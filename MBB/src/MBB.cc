...
void MBB::NewCalibrationPulse(){ // latest version of CalibrationPulse() function as instructed by Shanshan. (03/11/2024, Varuna Meddage)
    Write("CALIBRATION_PULSE", 0);
    //sleep(0.001);
    usleep(1000);
    Write("CALIBRATION_PULSE", 1);
...
void MBB::UseMBBPeriodicalCalibSrc(uint32_t pls_prd){ // Implemented as instructed by Shanshan (03/11/2024, Varuna Meddage)
