...
CommandReturn::status WIBTool::WIBDevice::Dump_WIB_FEMB_Status(std::vector<std::string> strArg,std::vector<uint64_t> intArg){ // Added by Varuna
 ...
 if (intArg.size() != 1){ 
   ...
   std::cout << std::left << std::setw(20) << "Bias Current" << std::left << std::setw(20) << Bias_curr << " A" << std::left << std::setw(80) 
             << bias_curr_comment << "\n";
   std::cout << std::left << std::setw(20) << "Bias Voltage" << std::left << std::setw(20) << FEMB_BIAS_V << " V" << "\n";	     
   std::cout << std::left << std::setw(20) << "FM_V39 Current" << std::left << std::setw(20) << FMV39_curr << " A" << std::left << std::setw(80) 
             << FMV39_curr_comment << "\n";
   std::cout << std::left << std::setw(20) << "FM_V39 Voltage" << std::left << std::setw(20) << FEMB_FMV39_V << " V" << std::left << std::setw(80) 
             << "\n";	     
   std::cout << std::left << std::setw(20) << "FM_V30 Current" << std::left << std::setw(20) << FMV30_curr << " A" << std::left << std::setw(80) 
             << FMV30_curr_comment << "\n";
   std::cout << std::left << std::setw(20) << "FM_V30 Voltage" << std::left << std::setw(20) << FEMB_FMV30_V << " V" << std::left << std::setw(80) 
             << "\n";	     
   std::cout << std::left << std::setw(20) << "FM_V18 Current" << std::left << std::setw(20) << FMV18_curr << " A" << std::left << std::setw(80) 
             << FMV18_curr_comment << "\n";
   std::cout << std::left << std::setw(20) << "FM_V18 Voltage" << std::left << std::setw(20) << FEMB_FMV18_V << " V" << std::left << std::setw(80) 
             << "\n";	     
   std::cout << std::left << std::setw(20) << "AM_V33 Current" << std::left << std::setw(20) << AMV33_curr << " A" << std::left << std::setw(80) 
             << AMV33_curr_comment << "\n";
   std::cout << std::left << std::setw(20) << "AM_V33 Voltage" << std::left << std::setw(20) << AMV33_volt << " V" << "\n";
   std::cout << std::left << std::setw(20) << "AM_V28 Current" << std::left << std::setw(20) << AMV28_curr << " A" << std::left << std::setw(80) 
             << AMV28_curr_comment << "\n";
   std::cout << std::left << std::setw(20) << "AM_V28 Voltage" << std::left << std::setw(20) << AMV28_volt << " V" << "\n";
   std::cout << std::left << std::setw(20) << "FEMB 2991 VCC Voltage" << std::left << std::setw(20) << FEMB_2991_VCC << " V" << "\n";
   std::cout << std::left << std::setw(20) << "FEMB 2991 Temperature" << std::left << std::setw(20) << FEMB_2991_T << " C" << "\n";
   std::cout << std::left << std::setw(20) << "FEMB PC" << std::left << std::setw(20) << FEMB_PC << " W" << "\n";
   std::cout << "\n";
   std::cout << "*******************************  WIB Parameters ******************************\n";
   std::cout << std::left << std::setw(20) << "WIB 2991 VCC Voltage " << std::left << std::setw(20) << WIB_2991_VCC << " V" << "\n";
   std::cout << std::left << std::setw(20) << "WIB 2991 Temperature " << std::left << std::setw(20) << WIB_2991_T << " C" << "\n";
   std::cout << std::left << std::setw(20) << "WIB BIAS Voltage " << std::left << std::setw(20) << WIB_BIAS_V << " V" << "\n";
   std::cout << std::left << std::setw(20) << "WIB BIAS Current " << std::left << std::setw(20) << WIB_BIAS_I << " A" << "\n";
   std::cout << std::left << std::setw(20) << "WIB V18 Voltage " << std::left << std::setw(20) << WIB_V18_V << " V" << "\n";
   std::cout << std::left << std::setw(20) << "WIB V18 Current " << std::left << std::setw(20) << WIB_V18_I << " A" << "\n";
   std::cout << std::left << std::setw(20) << "WIB V36 Voltage " << std::left << std::setw(20) << WIB_V36_V << " V" << "\n";
   std::cout << std::left << std::setw(20) << "WIB V36 Current " << std::left << std::setw(20) << WIB_V36_I << " A" << "\n";
   std::cout << std::left << std::setw(20) << "WIB V28 Voltage " << std::left << std::setw(20) << WIB_V28_V << " V" << "\n";
   std::cout << std::left << std::setw(20) << "WIB V28 Current " << std::left << std::setw(20) << WIB_V28_I << " A" << "\n";
   std::cout << std::left << std::setw(20) << "BIAS 2991 Voltage " << std::left << std::setw(20) << BIAS_2991_V << " V" << "\n";
   std::cout << std::left << std::setw(20) << "BIAS 2991 Temperature " << std::left << std::setw(20) << BIAS_2991_T << " C" << "\n";
   std::cout << std::left << std::setw(20) << "WIB PC " << std::left << std::setw(20) << WIB_PC << " W" << "\n";
