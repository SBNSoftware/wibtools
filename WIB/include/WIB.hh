...
//  uint8_t GetFakeCOLDATA();
  ...
  void CE_CHK_CFG(uint32_t iFEMB, uint8_t config_no, uint32_t pls_cs=0, uint32_t dac_sel=0, uint32_t fpgadac_en=0, uint32_t asicdac_en=0, 
                  uint32_t fpgadac_v=0, uint32_t pls_gap=500, uint32_t pls_dly=10, uint32_t mon_cs=0, uint32_t data_cs=0,
