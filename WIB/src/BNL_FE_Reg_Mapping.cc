...
void BNL_FE_Reg_Mapping::new_set_fe_board_for_chnl_testing(uint8_t config_no, uint32_t test_fst_chnl, uint32_t test_lst_chnl, uint32_t sts, uint32_t snc,                              uint32_t sg0, uint32_t sg1, uint32_t st0, uint32_t st1, uint32_t smn, uint32_t sdf, uint32_t slk0, uint32_t stb1, 
                             uint32_t stb, uint32_t s16, uint32_t slk1, uint32_t sdc, uint32_t swdac1, uint32_t swdac2, uint32_t dac){
     const std::string identification = "BNL_FE_Reg_Mapping::new_set_fe_board_for_chnl_testing";
