...
void WIB::CE_CHK_CFG(uint32_t iFEMB, uint8_t config_no, bool test_chnl_map, uint32_t chnl_fst, uint32_t chnl_lst, uint32_t pls_cs, uint32_t dac_sel,                           uint32_t fpgadac_en, uint32_t asicdac_en,uint32_t fpgadac_v, uint32_t pls_gap, uint32_t pls_dly, uint32_t mon_cs, uint32_t data_cs,                       uint32_t sts, uint32_t snc, uint32_t sg0, uint32_t sg1, uint32_t st0, uint32_t st1, uint32_t smn, uint32_t sdf,
   ...
   if (fecfg_loadflg) regs = {};
     ...
     if (test_chnl_map){ 
     //FEREG_MAP.set_fe_board_for_chnl_testing(config_no,chnl_no, sts, snc, sg0, sg1, st0, st1, smn, sdf, slk0, stb1, stb, s16, slk1, sdc, swdac1, swdac2, dac);
     FEREG_MAP.new_set_fe_board_for_chnl_testing(config_no, chnl_fst, chnl_lst, sts, snc, sg0, sg1, st0, st1, smn, sdf, slk0, stb1, stb, s16, slk1, sdc, swdac1, swdac2, dac);
   ...
   //sleep(2);
   //FEMB_UDPACQ_V2(iFEMB-1); // Remove this because it causes some bandwidth issues
